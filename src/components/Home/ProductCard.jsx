  ...
  return (
    <div className="w-full bg-white text-black p-4 hover:shadow-xl border border-gray-300 rounded-lg group overflow-hidden">
      ...
      <div className="px-2 flex flex-col gap-2">
        <p className="text-xs text-gray-500 tracking-wide">{item.category}</p>
        <p className="text-base font-medium">{item.title.substring(0, 20)}</p>
        <p className="flex  items-center gap-2">
          <span className=" text-amazon_blue font-semibold">${item.price}</span>
        </p>
